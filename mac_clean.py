...
SCREENSHOTS   = HOME / "Desktop" / "Screenshots"   # stays local, no iCloud
MISC          = DESKTOP / "Misc"
...
# ══════════════════════════════════════════════════════════════
# 1. SCREENSHOTS — sort into Desktop/Screenshots/YYYY/MM
# ══════════════════════════════════════════════════════════════
header("📸  Screenshots")
...
for source in [DESKTOP, DOWNLOADS]:
    ...
    for f in list(source.iterdir()):
        ...
        if m:
            dest_dir = SCREENSHOTS / m.group(1) / m.group(2)
        else:
            dest_dir = SCREENSHOTS / "Unsorted"
...
# Firefox (nested path)
for ff in (HOME / "Library/Caches/Firefox").rglob("cache2") if (HOME / "Library/Caches/Firefox").exists() else []:
    sz = dir_size(ff)
